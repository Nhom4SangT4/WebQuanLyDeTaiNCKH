...
<% 
  ...
  ResultSet resultset = 
  statement.executeQuery("select mssv, hoten, tendetai, linhvuc from dangkydetai Where TrangThai='DUYET'") ; 
  %>
...
">
    ...
    <div class="panel panel-default">
		...
		<a href="#" class="list-group-item "><span class="pull-right"></span>Liên Hệ</a>       
                ...
                <div class="col-md-9">
                    <ol class="breadcrumb">
  <li><a href="#">Home</a></li><li><a href="ThongKe.jsp">Thống Kê</a></li><li class="active">Danh Sách Đề Tài Được Duyệt</li></ol>    <div class="well-sm">
        <span>
            <span id="random_tin">
	...
	<TABLE class="table table-hover" >
            ...
            <% } %>
                    ...
                    <ol class="breadcrumb">
  <li><a href="#">Home</a></li><li><a href="ThongKe.jsp">Thống Kê</a></li><li class="active">Danh Sách Đề Tài Được Duyệt</li></ol>                 </div>
            </div>
        </div>
    </div>
    <div class="container">
