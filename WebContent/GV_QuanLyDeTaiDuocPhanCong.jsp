...
<head>
  ...
  <title>::. Quản Lý Đề Tài Được Phân Công .::</title>
...
">
    ...
    <div class="panel panel-default">
		...
		<a href="#" class="list-group-item "><span class="pull-right"></span>Liên Hệ</a>
                ...
                <div class="col-md-9">
                    <ol class="breadcrumb">
  <li><a href="#">Home</a></li><li class="active">Quản Lý đề tài được phân công</li></ol>    <div class="well-sm">
        <span>
            <span id="random_tin">
            ...
            <img src="images/new1.gif"/>
                        ...
                        <div  style="color: rgb(7, 132, 163);" class="panel-heading">
                            <h4 style="font-family: verdana;color:rgb(87,87,87);">Danh Mục đề tài được phân công</h4>
                        </div>
            ...
            <a href="GV_DeTaiDangHuongDan.jsp">
                <li class="article-area">
                    <p>
                    Danh sách các đề tài đang hướng dẫn                                                
                                                </p>
                </li>
            </a>
            ...
            <a href="GV_DeTaiDuocPhanCongPhanBien.jsp">
                <li class="article-area">
                    <p>
                 	Danh sách các đề tài được phân công phản biện                                               
                                                </p>
                </li>
            </a>       
        </ul>
                    ...
                    <ol class="breadcrumb">
  <li><a href="#">Home</a></li><li class="active">Quản Lý đề tài được phân công</li></ol></div>
            </div>
        </div>
    </div>
    <div class="container">
