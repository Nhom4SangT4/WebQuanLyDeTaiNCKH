...
<% 
  ...
  ResultSet resultset = 
  statement.executeQuery("select mssv, hoten, tendetai, linhvuc from dangkydetai where TrangThai='HUY'") ; 
  %>
          ...
          <div id="desktop-menu">
            <div class="panel panel-default">
              ...
              <a href="#" class="list-group-item "><span class="pull-right"></span>Liên Hệ</a>       
                ...
                <div class="col-md-9">
                    <ol class="breadcrumb">
  <li><a href="Home.jsp">Home</a></li><li><a href="ThongKe.jsp">Thống Kê</a></li><li class="active">Danh Sách Đề Tài Bị Loại</li></ol>    <div class="well-sm">
        <span>
            <span id="random_tin">
            ...
            <img src="images/bullet-blue-icon.png" />
                        ...
                        <div id="w">
	<center><h1>Danh Sách Đề Tài Bị Hủy</h1></center>
	<TABLE class="table table-hover" >
            <TR align="center">

                      
                      <th align="center" data-hide="phone"><u>MSSV</u></th>
                      <th align="center" data-hide="phone,tablet"><u>Họ Tên</u></th>
            ...
            <TR>
              ...
              <% } %>
                    ...
                    <ol class="breadcrumb">
  <li><a href="Home.jsp">Home</a></li><li><a href="ThongKe.jsp">Thống Kê</a></li><li class="active">Danh Sách Đề Tài Bị Loại</li></ol>                 </div>
            </div>
        </div>
    </div>
    <div class="container">
