...
">
  ...
  <h1>Danh sách Đề Tài được phân công phản biện</h1>
  <table class="table" data-page-size="5">
    	<thead>
    		<tr>
    			...
    			<th data-hide="phone,tablet">Thời gian phản biện </th>
...
<button onclick="if(document.getElementById('spoiler') .style.display=='none') {document.getElementById('spoiler') .style.display=''}else{document.getElementById('spoiler') .style.display='none'}" title="Click to show/hide" class="btn btn-success btn-xs">Chi tiết</button></td>
    ...
    <h1>Lịch phân công phản biện</h1>
  <table class="table" data-page-size="5">
    	<thead>
    		<tr>
                <th data="true">STT</th>
...
<button onclick="if(document.getElementById('spoiler') .style.display=='none') {document.getElementById('spoiler') .style.display=''}else{document.getElementById('spoiler') .style.display='none'}" title="Click to show/hide" class="btn btn-success btn-xs">Xuất lịch</button></td>
                                                                    </tr>
                                                    <tr>
                                <td><span class="text-info">2</span></td>
                                <td>IT002</td>
                                ...
                                <td>A5-302</td>
                                <td>22/12/2016</td>
                                                                        <td><a target="_blank" href="http://dkdt.fit.hcmute.edu.vn/chi-tiet-de-tai/phat-trien-ung-dung-da-nen-tang-cho-dien-thoai-di-dong-201609111473584798.html" class="btn btn-success btn-xs">Xuất lịch</a></td>
                                                                    </tr>
                                                    <tr>
                                <td><span class="text-info">3</span></td>
                                <td>IT003</td>
                                ...
                                <td>A5-301</td>
                                <td>05/01/2017</td>
                                                                        <td><a target="_blank" href="http://dkdt.fit.hcmute.edu.vn/chi-tiet-de-tai/xay-dung-ung-dung-quan-ly-cong-viec-cho-android-201609111473584799.html" class="btn btn-success btn-xs">Xuất lịch</a></td>
                                                                    </tr>
                                                    <tr>
                                <td><span class="text-info">4</span></td>
                                <td>IT004</td>
                                ...
                                <td>A4-403</td>
                                <td>02/12/2016</td>
                                                                        <td><a target="_blank" href="http://dkdt.fit.hcmute.edu.vn/chi-tiet-de-tai/lap-trinh-game-cho-dien-thoai-di-dong-201609111473584800.html" class="btn btn-success btn-xs">Xuất lịch</a></td>
                                                                    </tr>
                                ...
                                <td>A2-302</td>
                                <td>12/12/2016</td>
                                                                        <td><a target="_blank" href="http://dkdt.fit.hcmute.edu.vn/chi-tiet-de-tai/xay-dung-website-tra-cuu-ve-may-bay-su-dung-spring-mvc-framework-201609111473584823.html" class="btn btn-success btn-xs">Xuất lịch</a></td>
                                                                    </tr>
                            	</tbody>
    	<tfoot>
    		<tr>
