...
<% 
  ...
  ResultSet resultset = 
  statement.executeQuery("select madetai, tendetai,thoigianbatdau,thoigianketthuc,TrangThai  from dangkydetai") ; 
  %>
...
">
    ...
    <div class="panel panel-default">
		...
		<a href="NopBaoCao.jsp" class="list-group-item"><span class="pull-right"></span>Nộp Báo Cáo</a>      
                ...
                <div class="col-md-9">
                    <ol class="breadcrumb">
  <li><a href="HomeSinhVien.jsp">Home</a></li><li class="active">Tình Trạng Đề Tài</li></ol>
  <table class="table" data-page-size="5">
    		<TR align="center">
              ...
              <th align="center" data-hide="phone,tablet"><u>thời gian bắt đầu</u></th>
