...
">
  ...
  <li><a href="#">Home</a></li><li class="active">Thông báo</li></ol>    <div class="well-sm"></div>
	...
	<table cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse;">
			<h4 color ="#6495ED " align= "center">TÌNH TRẠNG ĐỀ TÀI PHÊ DUYỆT</h1>

				<tr align ="center" bgcolor="#6495ED" height="30px" cellspacing="10"  align="Cenleft" cellspacing="20"> 
					<td width="3%" cellspacing="10" >  SST </td>
					<td width="25%" cellspacing="10" >  Tên Đề Tài </td>
					<td width="18%" >  Giáo Viên Hướng Dẫn </td>
					<td width="8%" >  Chờ Phê Duyệt </td>
					<td width="8%" >  Đang Nghiệm Thu </td>
					<td width="10%" >  Đã Nghiệm Thu  </td>
				</tr>
				
				<tr > 
					<td> 1</td>
					<td> Nhận Diện Giọng Nói</td>
					<td> Nguyễn Văn A</td>
					<td align ="center"> <input type="checkbox" name=”Vip1”  ></td>
					<td align ="center"> <input checked="checked" type="checkbox" name=”Vip1”></td>
					<td align ="center"> <a href="DaNghiepThu.jsp" target="_blank"></a>  </td>
				</tr>
				
				<tr >  
					<td> 2</td>
					<td> Chơi Game Bằng Giọng Nói</td>
					<td> </td>
				...
				<tr > 
					...
					<td> Công Nghệ VR </td>
					<td> Ly Kim Chi</td>
					<td  align ="center"> <input checked="null" type="null" ></td>
					<td align ="center"> <input type="null"  ></td>
					<td align ="center"> <a href="Comment.jsp" target="_blank"> Chi tiết</a>  </td>
				</tr>
