              ...
              <form id="contactform" name="contact" action="quanlygiahanhuyServlet" method="post">
                <table border="0" cellpadding="0" cellspacing="0">
                  <div class="panel-body">
					...
					<div class="form-group">
                          <label for="txtthoigiangiahan" class="control-label">Gia hạn đến ngày </label>
                          <input id="txtthoigiangiahan" name="txtthoigiangiahan" min="2000-01-01" type="date" class="txt" tabindex="2" placeholder="mm/dd/yyyy" required/>
                    </div>
