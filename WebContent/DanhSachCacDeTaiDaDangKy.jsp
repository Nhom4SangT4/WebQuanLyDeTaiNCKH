  ...
  <div class="container">
    <div class="row">
      <div id="left-content">
        ...
        <div class="col-md-9">
          <ol class="breadcrumb">
            <li><a href="#">Home</a></li><li><a href="ThongKe.jsp">Thống Kê</a></li><li class="active">Danh Sách Đề Tài Đăng Ký</li></ol>    <div class="well-sm">
            <span>
              <span id="random_tin">
          ...
          <div id="w">
           <center><h1>Danh Sách Đề Tài Đã Đăng Ký</h1></center>
          ...
          <ol class="breadcrumb">
            <li><a href="#">Home</a></li><li><a href="ThongKe.jsp">Thống Kê</a></li><li class="active">Danh Sách Đề Tài Đăng Ký</li></ol>                 </div>
          </div>
        </div>
      </div>
      <div class="container">
